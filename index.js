...
function changeCoverForWard(){
    ...
    if(coverNumberForWard == 1){
        backGroundId.backgroundImage = "url('project_images/desktop-image-hero-1.jpg')";
        ...
        backGroundId.backgroundImage = "url('project_images/desktop-image-hero-2.jpg')";
        ...
        backGroundId.backgroundImage = "url('project_images/desktop-image-hero-3.jpg')";
